...
declare global {
  ...
  const E: typeof import('fp-ts/Either')['default']
  const Either: typeof import('fp-ts/Either')['Either']
  const Link: typeof import('react-router-dom')['Link']
  const NavLink: typeof import('react-router-dom')['NavLink']
  const Navigate: typeof import('react-router-dom')['Navigate']
  const Outlet: typeof import('react-router-dom')['Outlet']
  const RequestStateWrapper: typeof import('../src/stores/model')['RequestStateWrapper']
  const Route: typeof import('react-router-dom')['Route']
  const Routes: typeof import('react-router-dom')['Routes']
  const apiGet: typeof import('../src/utils/request')['apiGet']
  const apiPost: typeof import('../src/utils/request')['apiPost']
  const apiPostFormData: typeof import('../src/utils/request')['apiPostFormData']
  ...
  const delay: typeof import('../src/utils/async')['delay']
  const enableMapSet: typeof import('immer')['enableMapSet']
  const failure: typeof import('../src/stores/utils')['failure']
  const forwardRef: typeof import('react')['forwardRef']
  const getListApi: typeof import('../src/api/index')['getListApi']
  const immerable: typeof import('immer')['immerable']
  const isLeft: typeof import('fp-ts/Either')['isLeft']
  const isRight: typeof import('fp-ts/Either')['isRight']
  const kvstore: typeof import('../src/utils/kvstore')['default']
  const lazy: typeof import('react')['lazy']
  const left: typeof import('fp-ts/Either')['left']
  const logger: typeof import('../src/utils/logger')['default']
  const memo: typeof import('react')['memo']
  const ok: typeof import('../src/stores/utils')['ok']
  const original: typeof import('immer')['original']
  const pipe: typeof import('fp-ts/function')['pipe']
  const produce: typeof import('immer')['produce']
  const requestAction: typeof import('../src/stores/model')['requestAction']
  const reset: typeof import('../src/stores/utils')['reset']
  const retry: typeof import('../src/utils/retry')['retry']
  const retryE: typeof import('../src/utils/retry')['retryE']
  const right: typeof import('fp-ts/Either')['right']
  const shallow: typeof import('zustand/shallow')['shallow']
  const startTransition: typeof import('react')['startTransition']
  const testListApi: typeof import('../src/api/index')['testListApi']
  const to: typeof import('../src/utils/async')['to']
  const toE: typeof import('../src/utils/async')['toE']
  ...
  const useListStore: typeof import('../src/stores/index')['useListStore']
  ...
  const when: typeof import('../src/stores/model')['when']
}
